...
import { Home, Podcast, Settings } from "lucide-react";
...
export function DashboardSideBar() {
  ...
  return (
    <div className="w-72 h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 border-r border-slate-700/50 shadow-xl">
      {/* Header */}
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-slate-700/50">
        <div className="flex items-center space-x-3 px-3">
          ...
          <div>
            <p className="text-slate-300 text-sm font-medium">Baithk</p>
