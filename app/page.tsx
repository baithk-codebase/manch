    ...
    <div className="h-[100dvh] overflow-hidden flex flex-col md:pt-[16px] md:px-[16px] md:pb-[8px] p-2">
      <div className="grid grid-cols-[1fr_1fr]">
        <div className="flex items-center gap-3 justify-start">
          ...
          <h1 className="text-lg font-mono font-bold md:block hidden">
            BAITHK
          </h1>
      ...
      <div className="flex items-center justify-center gap-2 my-4">
        ...
        <button className="semi-primary">
          <SpeakerIcon className="aspect-square h-full p-0.5" />
        </button>
        <button className="semi-primary"> 
          <HandIcon className="aspect-square h-full p-0.5" />
        </button>
        <button className="semi-primary-danger"> 
